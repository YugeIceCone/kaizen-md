...
# Post-migration: gateway.py lives at scripts/mcp/ (depth 2 from plugin root).
# Per-domain MCP siblings live alongside; brain/indexers/handlers one level up.
sys.path.insert(0, str(Path(__file__).resolve().parent))  # scripts/mcp/
_SCRIPTS = Path(__file__).resolve().parents[1]            # scripts/
sys.path.insert(0, str(_SCRIPTS / "brain"))
sys.path.insert(0, str(_SCRIPTS / "indexers"))
sys.path.insert(0, str(_SCRIPTS / "handlers"))
