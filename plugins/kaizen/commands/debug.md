---
name: debug
description: "Universal error-locator + bin-smoke surface. Verbs - scan | parse | replay | lint | tail | smoke. Triggers - \"find errors\", \"smoke every bin\", \"static-scan for bugs\", \"replay this command\", \"tail stderr\"."
argument-hint: "[scan [--since 10m] [--source X] | parse [--stdin|--file] | replay <cmd> | lint [<path>...] | tail | smoke [--json]]"
