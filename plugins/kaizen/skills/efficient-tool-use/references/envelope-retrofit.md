...
| `loc_index` | `skills/workflow/scripts/loc_index.py` | A |
| `search_flow` | `skills/workflow/scripts/search_flow.py` | A |
| `claude_docs_index` | `skills/workflow/scripts/claude_docs_index.py` | A |
| `onboard_index` | `skills/workflow/scripts/onboard_index.py` | A |
...
| `scrape_index` | `skills/workflow/scripts/scrape_index.py` | D |
