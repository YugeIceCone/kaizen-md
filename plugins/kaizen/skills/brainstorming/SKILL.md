...
6. **Write design doc** — save to `.kaizen/docs/<YYYY-MM-DD>-<topic>/design.md` and commit
...
- Write the validated design (spec) to `.kaizen/docs/<YYYY-MM-DD>-<topic>/design.md`
...
- `.kaizen/docs/templates/parallel-branches-CHUNKING_FLOOR.md` — floor is explicit numeric value, not vibe
- `.kaizen/docs/templates/parallel-branches-PRE_DISPATCH_AUDIT.md::#2` — prompt generator must surface every owned path, never imply "you know what files you own"
- `.kaizen/docs/templates/chunk-plan-template.md::Guide` section — explicit `conventions: [...]` + `upstream_decisions: [...]` + `do_not_touch: [...]` for the same reason
