...
# MIGRATION BRIDGE — io helpers
sys.path.insert(0, str(_SCRIPT_DIR.parents[2] / "scripts" / "io"))
sys.path.insert(0, str(_SCRIPT_DIR.parents[2] / "scripts" / "quality"))

import _envelope  # noqa: E402

_emit = _envelope.emitter("kaizen-axis-runner", tool_version="1.0.0")
_PLUGIN_ROOT = _SCRIPT_DIR.parents[2]
_SCHEMA_PATH = (
